...
def uploadImage(key):
    ...
    return cv2.cvtColor(preProcessImg(cv2.imread('sample.png')),cv2.COLOR_BGR2RGB)

# About Me UI 

def aboutMe():
    
    st.markdown(requests.get(os.getenv('ABOUT_ME','https://raw.githubusercontent.com/Pratiksha228/Pratiksha228/main/README.md')).text, unsafe_allow_html=True)
